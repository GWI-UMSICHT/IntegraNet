...
model WaterHeatingDemand_scalable
...
//_________________________________________________________________________________//
 ...
 outer IntegraNet.SimCenter simCenter;
  ...
  // _____________________________________________
    ...
    parameter Real f=1 "Scaling factor";
  ...
  Modelica.Blocks.Math.Gain gain(k=f)
...
equation
 ...
 // _____________________________________________
  ...
  connect(gain.y, waterHeatingDemand) annotation (Line(points={{86,-43},{86,-43},{86,-80},{0,-80},{0,-100}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)),
    Documentation(info="<html>
<p><b><span style=\"font-family: MS Shell Dlg 2; color: #008000;\">1. Purpose of model</span></b></p>
<p>Model to read in heat demand for domestic hot water. The profile can be scaled to a total annual heat demand. </p>
...
end WaterHeatingDemand_scalable;
