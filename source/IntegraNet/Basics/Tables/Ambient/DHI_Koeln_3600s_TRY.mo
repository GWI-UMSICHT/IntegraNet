...
model DHI_Koeln_3600s_TRY
  "DHI Flensburg TRY, 1 h resolution, Source: DWD"
...
//_________________________________________________________________________________//
  ...
  // _____________________________________________
    ...
    parameter Integer columns[:]={6}    "Columns of table to be interpolated";
