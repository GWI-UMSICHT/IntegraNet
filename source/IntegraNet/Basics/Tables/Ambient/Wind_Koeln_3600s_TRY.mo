...
model Wind_Koeln_3600s_TRY
  "Wind Flensburg TRY, 1 h resolution, Source: DWD"
...
//_________________________________________________________________________________//
  ...
  // _____________________________________________
    ...
    parameter Integer columns[:]={9}    "Columns of table to be interpolated";
...
<p>Table to read in wind speed data for a test reference year for Koeln.</p>
