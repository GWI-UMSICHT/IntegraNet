...
model Temperature_Duesseldorf_1m_3600s_TMY "Duesseldorf 1m depth 2017, 1 h resolution, Source: DWD-CDC"
...
//_________________________________________________________________________________//
  ...
  extends TransiEnt.Components.Boundaries.Ambient.Base.PartialTemperature;
    ...
    parameter String fileName = Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Ambient/T_ground_Duesseldorf_1m_17.txt") annotation(choices(choice=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Ambient/T_ground_Duesseldorf_1m_17.txt")));
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
            {100,100}})));
end Temperature_Duesseldorf_1m_3600s_TMY;
