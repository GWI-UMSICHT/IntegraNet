...
model DNI_Koeln_3600s_TRY
  "DNI Flensburg TRY, 1 h resolution, Source: DWD/calculation"
...
//_________________________________________________________________________________//
  ...
  // _____________________________________________
    ...
    parameter Integer columns[:]={5}    "Columns of table to be interpolated";
...
<p>Table to read in direct normal irradiation data for a test reference year for Koeln.</p>
