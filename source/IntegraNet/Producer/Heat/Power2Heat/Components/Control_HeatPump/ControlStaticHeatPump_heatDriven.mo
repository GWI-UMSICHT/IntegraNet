...
model ControlStaticHeatPump_heatDriven "heat-driven static heat pump"
...
equation
  ...
  connect(T, hysteresis_HP.u) annotation (Line(points={{-102,20},{-80,20},{-80,0},{-28.8,0}},
                                                                                color={0,0,127}));
  connect(T_HP.y, T_set_HP) annotation (Line(points={{80.9,71},{80.9,70},{106,70}}, color={0,0,127}));
  connect(switch1.y, P_set_HP) annotation (Line(points={{80.8,6.66134e-016},{80.8,0},{108,0}},         color={0,0,127}));
...
end ControlStaticHeatPump_heatDriven;
