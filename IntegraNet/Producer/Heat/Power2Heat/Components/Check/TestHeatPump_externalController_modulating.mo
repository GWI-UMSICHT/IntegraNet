...
model TestHeatPump_externalController_modulating
...
//_________________________________________________________________________________//
  ...
  Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow heating annotation (Placement(transformation(extent={{-28,-32},{-10,-14}})));
...
equation
  ...
  connect(heating.port, heatBdryFloorHeatingDeload.port) annotation (Line(points={{-10,-23},{8,-23},{8,-8},{38,-8}}, color={191,0,0}));
  ...
  connect(grid.epp, apparentPower.epp) annotation (Line(
      points={{-135.93,-75.07},{-136,-75.07},{-136,-44.08},{-130.08,-44.08}},
      color={0,127,0},
      thickness=0.5));
  connect(controller.P_set_HP, apparentPower.P_el_set) annotation (Line(
      points={{-117.5,21.9},{-108,21.9},{-108,-20},{-126.8,-20},{-126.8,-34.4}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(T_stor_is.T, controller.T) annotation (Line(points={{-28,14},{-48,14},{-48,10},{-68,10},{-68,44},{-154,44},{-154,22},{-137.8,22}}, color={0,0,127}));
...
end TestHeatPump_externalController_modulating;
