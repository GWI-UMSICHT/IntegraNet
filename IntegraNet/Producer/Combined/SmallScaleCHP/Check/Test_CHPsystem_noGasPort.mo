...
model Test_CHPsystem_noGasPort
...
//_________________________________________________________________________________//
  ...
  inner SimCenter simCenter(
    ...
    calculateCost=true,
    integrateCDE=true)                                                                             annotation (Placement(transformation(extent={{-108,80},{-88,100}})));
  ...
  CHPSystem_noGasPort
            cHPSystem_noGasPort
                      annotation (Placement(transformation(extent={{-50,-14},{-6,20}})));
...
equation
  connect(grid.epp, cHPSystem_noGasPort.epp) annotation (Line(
      points={{-82,-39},{-45.82,-39},{-45.82,-14.85}},
      color={0,127,0},
      thickness=0.5));
  connect(ramp.y, cHPSystem_noGasPort.Q_Demand) annotation (Line(points={{7,58},{-27.78,58},{-27.78,19.49}}, color={0,0,127}));
  annotation (
