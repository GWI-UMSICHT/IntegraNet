...
model Temperature_Koeln_3600s_TRY
  "Temperature Flensburg, 1 h resolution, Source: DWD"
...
<p>Table to read in temperature data for a test reference year for Koeln.</p>
...
end Temperature_Koeln_3600s_TRY;
