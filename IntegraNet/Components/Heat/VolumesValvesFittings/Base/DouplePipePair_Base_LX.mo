...
model DouplePipePair_Base_LX "Model of a pair of district heating pipes"
...
//_________________________________________________________________________________//
  ...
  parameter SI.Length diameter_i = simCenter.DNmat[IntegraNet.Basics.Functions.getIndex(DN,simCenter.DHN_Pipe_Manufacturer.rowAmount,simCenter.DNmat),2] "Inner diameter of the carrier pipe";
  parameter SI.Length diameter_o = simCenter.DNmat[IntegraNet.Basics.Functions.getIndex(DN,simCenter.DHN_Pipe_Manufacturer.rowAmount,simCenter.DNmat),3] "Outer diameter of the insulation including casing";
  parameter SI.Length pipe_wall_thickness = simCenter.DNmat[IntegraNet.Basics.Functions.getIndex(DN,simCenter.DHN_Pipe_Manufacturer.rowAmount,simCenter.DNmat),4] "Pipe wall thickness of the carrier pipe";
