...
//_________________________________________________________________________________//
  ...
  Modelica.Blocks.Interfaces.RealInput
                              u annotation (Placement(transformation(extent={{-130,
            -20},{-90,20}}), iconTransformation(extent={{-130,-20},{-90,20}})));
  Modelica.Blocks.Interfaces.RealInput
                              uHigh
                                annotation (Placement(transformation(extent={{-126,60},
            {-86,100}}), iconTransformation(extent={{-126,60},{-86,100}})));
  Modelica.Blocks.Interfaces.RealInput
                              uLow
                                annotation (Placement(transformation(extent={{-130,
            -100},{-90,-60}}), iconTransformation(extent={{-130,-100},{-90,-60}})));
initial equation
  pre(y) = pre_y_start;
equation
