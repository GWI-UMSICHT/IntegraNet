...
model Check_PipeFlow_L4_Simple_varXi_dp_phy_simple
...
//_________________________________________________________________________________//
  ...
  PipeFlow_L4_Simple_varXi pipe annotation (Placement(transformation(extent={{-20,-12},{22,10}})));
...
end Check_PipeFlow_L4_Simple_varXi_dp_phy_simple;
