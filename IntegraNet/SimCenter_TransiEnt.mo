within IntegraNet;
model SimCenter_TransiEnt "SimCenter for global parameters, ambient conditions and collecting statistics"
...
// ++++++++                                                                        //
// This component is a modification of model SimCenter from TransiEnt Library,     //
// version: 1.3.0                                                                  //
//
  ...
  replaceable Basics.Tables.HeatGrid.HeatingCurves.ConstantSupplyTemperature heatingCurve constrainedby TransiEnt.Basics.Tables.HeatGrid.HeatingCurves.PartialHeatingCurve "Heating curve defining supply and return water temperatures" annotation (Dialog(tab="District Heating Grid"), choicesAllMatching);
