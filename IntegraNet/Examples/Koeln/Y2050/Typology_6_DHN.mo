within IntegraNet.Examples.Koeln.Y2050;
...
//_________________________________________________________________________________//
  inner IntegraNet.SimCenter simCenter(
    redeclare Components.Boundaries.Ambient.AmbientConditions_Koeln_TRY ambientConditions,
    ...
    annotation (Placement(transformation(extent={{-378,292},{-344,322}})));
  ...
  IntegraNet.Components.Heat.VolumesValvesFittings.DoublePipePair_LX HL_1(
    ...
    T_start_return=303.15,                                                length=22,
    DN=125)                                                               annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=-90,
        origin={-236,-20})));
  ...
  ClaRa.Components.BoundaryConditions.BoundaryVLE_pTxi Grid_Supply_Out(p_const(displayUnit="bar") = simCenter.p_nom[2],
                                                                                                            T_const(displayUnit="degC") = simCenter.T_supply)
                                                                                                                                                  annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=270,
        origin={-226,-58})));
  ClaRa.Components.BoundaryConditions.BoundaryVLE_Txim_flow Grid_Return_In(m_flow_const=10, T_const(displayUnit="degC") = simCenter.T_return)
                                                                                                                                  annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={-252,264})));
  ...
  IntegraNet.GridConstructor.Grid_Constructor GC_1(
    ...
    redeclare model Demand_Consumer_1 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_1.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_1.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_1.csv")),
    ...
    n_elements=2) annotation (Placement(transformation(extent={{-304,162},{-376,218}})));
  IntegraNet.GridConstructor.Grid_Constructor GC_4(
    ...
    redeclare model Systems_Consumer_2 = GridConstructor.Systems.IndependentTechnologies_noGasGrid,
    redeclare model Demand_Consumer_1 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_4.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_4.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_4.csv")),
    redeclare model Demand_Consumer_2 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_4.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_4.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_4.csv")),
    start_c1=1,
    start_c2=5,
  ...
  IntegraNet.GridConstructor.Grid_Constructor GC_6(
    ...
    redeclare model Systems_Consumer_2 = GridConstructor.Systems.IndependentTechnologies_noGasGrid,
    redeclare model Demand_Consumer_1 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_6.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_6.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_6.csv")),
    redeclare model Demand_Consumer_2 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_6.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_6.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_6.csv")),
  ...
  IntegraNet.GridConstructor.Grid_Constructor GC_3(
    ...
    redeclare model Systems_Consumer_2 = GridConstructor.Systems.IndependentTechnologies_noGasGrid,
    redeclare model Demand_Consumer_1 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_3.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_3.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_3.csv")),
    redeclare model Demand_Consumer_2 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_3.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_3.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_3.csv")),
    ...
    redeclare model HeatTransfer = IntegraNet.Components.Heat.VolumesValvesFittings.Base.HT_Single_Buried_LX,
    dhn_lambda_insulation={0.023,0.023},
    n_elements=2) annotation (Placement(transformation(extent={{-306,81},{-378,137}})));
  IntegraNet.GridConstructor.Grid_Constructor GC_5(
    ...
    redeclare model Systems_Consumer_2 = GridConstructor.Systems.IndependentTechnologies_noGasGrid,
    redeclare model Demand_Consumer_1 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_5.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_5.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_5.csv")),
    redeclare model Demand_Consumer_2 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_5.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_5.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_5.csv")),
  ...
  IntegraNet.GridConstructor.Grid_Constructor GC_2(
    ...
    redeclare model Systems_Consumer_2 = GridConstructor.Systems.IndependentTechnologies_noGasGrid,
    redeclare model Demand_Consumer_1 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_2.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_2.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_2.csv")),
    redeclare model Demand_Consumer_2 = IntegraNet.Consumer.Consumer_combined.Data.Demand_3Tables (
        fileName_el=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/electricity/GC_2.csv"),
        fileName_q_heating=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/heat/GC_2.csv"),
        fileName_q_water=Modelica.Utilities.Files.loadResource("modelica://IntegraNet/Data/Demand/Typology_Profiles/Koeln/2050/T_6/tww/GC_2.csv")),
...
equation
  ...
  connect(GC_3.epp_p,ElectricGrid. epp) annotation (Line(
      points={{-306,95},{-234,95},{-234,242},{-260,242}},
      color={0,127,0},
      thickness=0.5));
  ...
  annotation (
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-480,-80},{100,320}}), graphics={
        ...
        Text(
          ...
          textString="22 m"),
        Text(
          extent={{-160,336},{-2,228}},
          lineColor={28,108,200},
          textString="Koeln 2050
"),     Text(
          extent={{-82,58},{100,-22}},
          lineColor={0,0,0},
          lineThickness=0.5,
